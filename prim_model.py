...
def add_model(app, params, path_for_objects, stage, model_object, materials_map, root_path):
    ...
    for obj in model_object.Children:
        export_processor.export_step(app, params, model_path_for_objects, ref_stage, obj, model_objects, materials_map, "/" + model_object.Name)
