...
def export(app, file_path, params):
    ...
    if len(params["objects_list"]) == 1 and params["objects_list"][0].ObjectID == app.ActiveProject2.ActiveScene.Root.ObjectID:
        for obj in app.ActiveProject2.ActiveScene.Root.Children:
            export_step(app, params, stage, obj, exported_objects, root_path)
    else:
...
def export_step(app, params, stage, obj, exported_objects, root_path):
    ...
    if obj.ObjectID not in exported_objects:
        ...
        if obj_type == constants.siPolyMeshType and obj_type in opt_object_types:
            usd_pointer = prim_mesh.add_mesh(app, params, stage, obj, root_path)
        elif obj_type == constants.siCameraPrimType and obj_type in opt_object_types:
            usd_pointer = prim_camera.add_camera(app, params, stage, obj, root_path)
        elif obj_type == constants.siLightPrimType and obj_type in opt_object_types:
            usd_pointer = prim_light.add_light(app, params, stage, obj, root_path)
            ...
            usd_pointer = prim_hair.add_strands(app, params, stage, obj, root_path)
            ...
            usd_pointer = prim_xform.add_xform(app, params, stage, obj, root_path)
        else:
        ...
        if usd_pointer is not None:
            ...
            for child in obj.Children:
                export_step(app, params, stage, child, exported_objects, str(usd_pointer.GetPath()))
